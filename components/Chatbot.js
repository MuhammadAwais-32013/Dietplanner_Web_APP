                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={e => {
                          ...
                          setMedicalCondition(prev => ({ ...prev, height: e.target.value }));
                        }}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={e => {
                          ...
                          setMedicalCondition(prev => ({ ...prev, weight: e.target.value }));
                        }}
                        className="w-full px-2 py-1.5 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                        placeholder="70"
                        required
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={e => {
                            ...
                            if (systolic <= 0) {
                              alert('Systolic pressure must be greater than 0');
                              return;
                            }
                            setMedicalCondition(prev => ({ ...prev, systolic: e.target.value }));
                          }}
                          className="w-full px-2 py-1.5 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                          required
                        />
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={e => {
                            ...
                            if (diastolic <= 0) {
                              alert('Diastolic pressure must be greater than 0');
                              return;
                            }
                            setMedicalCondition(prev => ({ ...prev, diastolic: e.target.value }));
                          }}
                          className="w-full px-2 py-1.5 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                          required
                        />
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          if (invalidFiles.length > 0) {
                            alert('Only PDF files are allowed. Please upload PDF documents only.');
